...
#Aqui creamos el objeto moto q hereda  de la clase vehiculo
...
#Aqui creamos el objeto furgoneta q hereda  de la clase vehiculo
...
#Aqui creamos la clase BicicletaElectrica q hereda de la clases VElectricos y Vehiculos
class BicicletaElectrica(VElectricos,Vehiculos):
	pass
	
miBiciElectrica=BicicletaElectrica("Orbea","Hj")#y Ahora si se le puede pasar los valores 	